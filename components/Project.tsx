...
const Project = ({ title, description, tags, imageUrl }: ProjectProps) => {
  ...
  return (
    ...
    >
      <section className="relative max-w-2xl overflow-hidden rounded-lg border border-black/5 bg-gray-100 transition hover:bg-gray-200 dark:bg-white/10 dark:text-white dark:hover:bg-white/20 sm:h-80 sm:pr-8 sm:group-even:pl-8">
